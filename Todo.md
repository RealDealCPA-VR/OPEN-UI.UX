...
- [ ] Settings UI (providers, approvals, MCP servers, plugins, theme, indexing) _(theme, workspace, providers, approvals, audit log, indexing all shipped as Settings subsections; indexing is a Phase-3-pending stub. Onboarding affordance (`OnboardingBanner`) renders at top of Settings when no providers configured and scrolls to Providers section. MCP servers gated by Phase 2.5; plugins gated by Phase 4)_
